...
Quick validation run:
    ...
    python tools/dataset_converters/grasp_tools/augment.py \
        --out-dir /tmp/grasp_tools_v3_smoke --smoke-test --overwrite
"""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--src-dir", default="assets/grasp_tools/graspall_v3")
    parser.add_argument("--background-dir", default="assets/grasp_tools/backgrounds")
    parser.add_argument(
        "--out-dir", default="datasets/grasp-tools/aug_graspall_v3_15k"
    )
